...
class Face(models.Model):
    framenum = models.IntegerField(blank=True, null=True)
...
class FaceRecognitionIndex(models.Model):
    face_recognition = models.TextField(blank=True, null=True)
    sensitive_personnel_id = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'face_recognition_index'
...
class Ipcamera(models.Model):
    ...
    zongjiao_addrinfo_id = models.IntegerField(blank=True, null=True)
...
class SensitivePersonnel(models.Model):
    ...
    face_address = models.CharField(max_length=255, blank=True, null=True)
...
class TempleFace(models.Model):
    face_address = models.CharField(max_length=255, blank=True, null=True)
    ipcamera = models.PositiveIntegerField(blank=True, null=True)
    create_time = models.DateTimeField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'temple_face'
